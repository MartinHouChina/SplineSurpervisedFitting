...
Checkpoint: `/home/feng/HouCode/SplineFitting_1070_overnight/outputs/checkpoints/overnight_stable_k32_3090_r1.pt`（candidate_selection_counterfactual_bspline_v16，epoch 14）。
...
|---|---|---:|---:|---:|---:|---:|---:|
| Synthetic | Ours v16 learned | 42 | 59.5% | 6.703e-05 | 25.36 | 8.52 | 7.13 |
| Synthetic | Park & Lee 2007 (DOM adaptation) | 42 | 26.2% | 1.361e-04 | 30.40 | 39.24 | — |
| Synthetic | Liang et al. 2017 (feature-IKI adaptation) | 42 | 45.2% | 1.316e-04 | 27.43 | 29.09 | — |
| Synthetic | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 42 | 66.7% | 5.386e-05 | 23.76 | 408.07 | — |
| Synthetic | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 42 | 47.6% | 9.951e-05 | 28.71 | 294.61 | — |
| Synthetic | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 42 | 52.4% | 1.036e-04 | 25.71 | 1459.87 | — |
| UJI | Ours v16 learned | 20 | 90.0% | 1.769e-05 | 20.55 | 8.47 | 7.11 |
| UJI | Park & Lee 2007 (DOM adaptation) | 20 | 100.0% | 3.388e-05 | 11.80 | 15.79 | — |
| UJI | Liang et al. 2017 (feature-IKI adaptation) | 20 | 100.0% | 3.380e-05 | 8.85 | 8.42 | — |
| UJI | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 20 | 100.0% | 3.140e-05 | 7.35 | 106.92 | — |
| UJI | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 20 | 100.0% | 2.413e-05 | 18.50 | 779.16 | — |
| UJI | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 20 | 100.0% | 2.857e-05 | 10.45 | 2542.54 | — |
| NaturalEarth | Ours v16 learned | 20 | 40.0% | 1.659e-04 | 26.15 | 8.54 | 7.12 |
| NaturalEarth | Park & Lee 2007 (DOM adaptation) | 20 | 80.0% | 1.531e-04 | 22.40 | 30.03 | — |
| NaturalEarth | Liang et al. 2017 (feature-IKI adaptation) | 20 | 85.0% | 1.211e-04 | 20.95 | 21.40 | — |
| NaturalEarth | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 20 | 85.0% | 1.281e-04 | 18.90 | 334.76 | — |
| NaturalEarth | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 20 | 75.0% | 1.500e-04 | 31.40 | 342.57 | — |
| NaturalEarth | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 20 | 75.0% | 1.350e-04 | 21.60 | 1825.20 | — |
| USGS | Ours v16 learned | 20 | 30.0% | 1.675e-04 | 27.80 | 8.54 | 7.12 |
| USGS | Park & Lee 2007 (DOM adaptation) | 20 | 40.0% | 2.392e-04 | 25.15 | 32.20 | — |
| USGS | Liang et al. 2017 (feature-IKI adaptation) | 20 | 45.0% | 1.266e-04 | 24.25 | 25.68 | — |
| USGS | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 20 | 45.0% | 1.368e-04 | 23.20 | 469.07 | — |
| USGS | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 20 | 40.0% | 1.573e-04 | 29.65 | 269.17 | — |
| USGS | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 20 | 40.0% | 1.502e-04 | 23.55 | 1415.61 | — |
| IndustrialOffset | Ours v16 learned | 20 | 85.0% | 3.224e-05 | 18.90 | 8.44 | 7.12 |
| IndustrialOffset | Park & Lee 2007 (DOM adaptation) | 20 | 90.0% | 4.410e-05 | 14.80 | 21.62 | — |
| IndustrialOffset | Liang et al. 2017 (feature-IKI adaptation) | 20 | 100.0% | 2.962e-05 | 11.30 | 10.94 | — |
| IndustrialOffset | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 20 | 100.0% | 3.499e-05 | 10.10 | 132.73 | — |
| IndustrialOffset | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 20 | 100.0% | 1.520e-05 | 22.40 | 734.77 | — |
| IndustrialOffset | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 20 | 100.0% | 3.136e-05 | 11.55 | 2685.48 | — |
...
|---|---|---|---:|---:|---:|---:|---:|
| Synthetic | Ours v16 learned | 输入点 | 4.978e-04 | 1.674e-03 | 2.433e-03 | 2.831e-04 | 42/0 |
...
| UJI | Ours v16 learned | 输入点 | 2.675e-04 | 5.810e-04 | 8.005e-04 | 6.000e-05 | 20/0 |
| UJI | Ours v16 learned | 原始参考点 | 3.601e-04 | 1.109e-03 | 1.440e-03 | 9.803e-05 | 20/0 |
...
| NaturalEarth | Ours v16 learned | 输入点 | 1.308e-03 | 5.619e-03 | 8.580e-03 | 1.609e-03 | 20/0 |
| NaturalEarth | Ours v16 learned | 原始参考点 | 1.505e-03 | 6.832e-03 | 9.465e-03 | 1.643e-03 | 20/0 |
...
| USGS | Ours v16 learned | 输入点 | 1.113e-03 | 3.637e-03 | 3.899e-03 | 6.156e-04 | 20/0 |
| USGS | Ours v16 learned | 原始参考点 | 1.185e-03 | 4.082e-03 | 4.158e-03 | 6.373e-04 | 20/0 |
...
| IndustrialOffset | Ours v16 learned | 输入点 | 4.008e-04 | 1.770e-03 | 1.870e-03 | 1.816e-04 | 20/0 |
| IndustrialOffset | Ours v16 learned | 原始参考点 | 4.558e-04 | 1.772e-03 | 1.872e-03 | 1.812e-04 | 20/0 |
...
|---|---|---:|---:|
| UJI | Ours v16 learned | 85.0% | 2.895e-05 |
...
| NaturalEarth | Ours v16 learned | 45.0% | 1.676e-04 |
...
| USGS | Ours v16 learned | 30.0% | 1.688e-04 |
...
| IndustrialOffset | Ours v16 learned | 85.0% | 3.237e-05 |
