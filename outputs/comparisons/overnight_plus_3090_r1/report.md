...
诊断原因：certified synthetic count MAE exceeds the formal limit 2；certified synthetic knot-match F1 is below the formal minimum 0.6；certified synthetic matched-knot MAE exceeds the formal limit 0.005

Checkpoint: `/home/feng/HouCode/SplineFitting_1070_overnight/outputs/checkpoints/overnight_plus_3090_r1.pt`（candidate_selection_counterfactual_bspline_v16，epoch 93）。
...
|---|---|---:|---:|---:|---:|---:|---:|
| Synthetic | Ours v16 learned | 42 | 90.5% | 2.870e-05 | 23.12 | 8.05 | 6.69 |
| Synthetic | Park & Lee 2007 (DOM adaptation) | 42 | 100.0% | 4.418e-05 | 39.19 | 56.67 | — |
| Synthetic | Liang et al. 2017 (feature-IKI adaptation) | 42 | 100.0% | 4.641e-05 | 35.88 | 41.25 | — |
| Synthetic | Dung & Tjahjowidodo 2017 (serial adaptation) | 42 | 0.0% | 1.047e-03 | 14.81 | 373.66 | — |
| Synthetic | Kang 2015 (ADMM adaptation) | 42 | 23.8% | 3.237e-03 | 5.29 | 748.96 | — |
| Synthetic | Luo et al. 2022 (l-infinity,1 + DE adaptation) | 42 | 16.7% | 2.464e-03 | 10.33 | 2733.48 | — |
| UJI | Ours v16 learned | 8 | 87.5% | 2.255e-05 | 21.00 | 7.99 | 6.64 |
| UJI | Park & Lee 2007 (DOM adaptation) | 8 | 100.0% | 3.834e-05 | 9.12 | 11.59 | — |
| UJI | Liang et al. 2017 (feature-IKI adaptation) | 8 | 100.0% | 3.103e-05 | 7.50 | 7.61 | — |
| UJI | Dung & Tjahjowidodo 2017 (serial adaptation) | 8 | 25.0% | 6.258e-04 | 3.62 | 87.64 | — |
| UJI | Kang 2015 (ADMM adaptation) | 8 | 75.0% | 4.673e-05 | 6.12 | 1115.47 | — |
| UJI | Luo et al. 2022 (l-infinity,1 + DE adaptation) | 8 | 37.5% | 6.226e-04 | 3.75 | 2892.12 | — |
| NaturalEarth | Ours v16 learned | 8 | 50.0% | 1.002e-04 | 23.00 | 8.05 | 6.66 |
| NaturalEarth | Park & Lee 2007 (DOM adaptation) | 8 | 100.0% | 4.367e-05 | 24.88 | 37.94 | — |
| NaturalEarth | Liang et al. 2017 (feature-IKI adaptation) | 8 | 100.0% | 4.714e-05 | 24.50 | 27.20 | — |
| NaturalEarth | Dung & Tjahjowidodo 2017 (serial adaptation) | 8 | 0.0% | 6.609e-04 | 11.00 | 278.83 | — |
| NaturalEarth | Kang 2015 (ADMM adaptation) | 8 | 12.5% | 6.741e-03 | 9.00 | 840.42 | — |
| NaturalEarth | Luo et al. 2022 (l-infinity,1 + DE adaptation) | 8 | 0.0% | 2.260e-03 | 6.00 | 2636.37 | — |
| USGS | Ours v16 learned | 8 | 25.0% | 9.208e-05 | 31.38 | 8.12 | 6.66 |
| USGS | Park & Lee 2007 (DOM adaptation) | 8 | 100.0% | 4.656e-05 | 33.25 | 47.58 | — |
| USGS | Liang et al. 2017 (feature-IKI adaptation) | 8 | 100.0% | 4.057e-05 | 29.50 | 34.35 | — |
| USGS | Dung & Tjahjowidodo 2017 (serial adaptation) | 8 | 12.5% | 2.618e-04 | 15.12 | 388.67 | — |
| USGS | Kang 2015 (ADMM adaptation) | 8 | 25.0% | 4.362e-03 | 3.50 | 724.57 | — |
| USGS | Luo et al. 2022 (l-infinity,1 + DE adaptation) | 8 | 25.0% | 7.746e-04 | 8.50 | 2453.88 | — |

真实曲线原始参考点测试：仅在 192 个重采样输入点上拟合，原始参考点集不直接用于 refit。UJI 通常从较少原始点上采样，这不产生新的独立观测。通过率由参考点 MSE 单独判定。

| 数据集 | 方法 | 参考点通过率 | 参考点 MSE |
|---|---|---:|---:|
| UJI | Ours v16 learned | 87.5% | 2.753e-05 |
...
| NaturalEarth | Ours v16 learned | 50.0% | 1.001e-04 |
...
| USGS | Ours v16 learned | 37.5% | 8.990e-05 |
