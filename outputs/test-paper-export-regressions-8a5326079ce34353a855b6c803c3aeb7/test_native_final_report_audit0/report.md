...
Checkpoint: `report-fixture.pt`（candidate_selection_counterfactual_bspline_v16，epoch 1）。
...
|---|---|---:|---:|---:|---:|---:|---:|
| Synthetic | Ours v16 learned | 1 | 100.0% | 4.000e-05 | 22.00 | 7.00 | 1.00 |
| Synthetic | Park & Lee 2007 (DOM adaptation) | 1 | 100.0% | 4.000e-05 | 22.00 | 7.00 | — |
| Synthetic | Liang et al. 2017 (feature-IKI adaptation) | 1 | 100.0% | 4.000e-05 | 22.00 | 7.00 | — |
| Synthetic | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 1 | 100.0% | 4.000e-05 | 22.00 | 7.00 | — |
| Synthetic | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 1 | 100.0% | 4.000e-05 | 22.00 | 7.00 | — |
| Synthetic | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 1 | 100.0% | 4.000e-05 | 22.00 | 7.00 | — |
...
|---|---|---|---:|---:|---:|---:|---:|
| Synthetic | Ours v16 learned | 输入点 | N/A | N/A | N/A | 4.000e-05 | 0/1 |
| Synthetic | Park & Lee 2007 (DOM adaptation) | 输入点 | N/A | N/A | N/A | 4.000e-05 | 0/1 |
| Synthetic | Liang et al. 2017 (feature-IKI adaptation) | 输入点 | N/A | N/A | N/A | 4.000e-05 | 0/1 |
| Synthetic | Dung & Tjahjowidodo 2017 (serial adaptation) [threshold-safe adaptation] | 输入点 | N/A | N/A | N/A | 4.000e-05 | 0/1 |
| Synthetic | Kang 2015 (ADMM adaptation) [threshold-safe adaptation] | 输入点 | N/A | N/A | N/A | 4.000e-05 | 0/1 |
| Synthetic | Luo et al. 2022 (l-infinity,1 + DE adaptation) [threshold-safe adaptation] | 输入点 | N/A | N/A | N/A | 4.000e-05 | 0/1 |
...
外部曲线原始参考点测试（包括程序生成工业等距线）：仅在 96 个重采样输入点上拟合，原始参考点集不直接用于 refit。UJI 通常从较少原始点上采样，这不产生新的独立观测。通过率由参考点 MSE 单独判定。
