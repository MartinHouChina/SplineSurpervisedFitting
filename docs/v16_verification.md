...
| 模块 | 已验证内容 |
|---|---|
| Candidate network | Kc=56 稠密候选、严格有序参数/候选、局部 cross-attention |
...
| Mixed data | Synthetic K=4..56 使用显式 `knot_min_span=0.01`；UJI、Natural Earth、USGS 训练/验证分离和真实无标签路由 |
...
- objective、架构和一次性 mass-TopK 部署合同一致；
